  ...
  <!-- Page Title -->
    ...
    <section >
      <div class="row heading mb-20">
        <p class="text-center"><img src="../img/4s.jpg" width="950" ></p>
          ...
          <div class="container testimonial">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <p class="rb tx4">Notre équipe professionnelle, vous offre un service d'accompagnement et de conseils pour vous guider à l'excellence de la réalisation de vos projets.<br/>
                Ainsi la réalisation des plans de piquetages afin de savoir le budget prévisionnel de vos projets et les plans de récolement pour finaliser les travaux avec par exemple (Autocad ..)
                </p>
              </div>
            </div>
          </div>
